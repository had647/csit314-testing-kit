...
def run_test_radius():
    print("Running Radius Test Oracle now...")
    ...
    for i in range(5):
        ...
        testCase = "Results Displayed when radius of location is altered (UnitOne is the radius which is generated randomly 5 times and tested against results from UnitTwo which is Unit1 + 5km)"
        ...
        if radius_1 > radius_2:
            if radius1Total > radius2Total:
                ...
                outputCSV(testCase, True, expectedResult, radius2Total)
            else:
                print("Test has failed.")
                print("Results found for radius of", radius_1, "is:", radius1Total)
                print("Results found for radius of", radius_2, "is:", radius2Total)
                outputCSV(testCase, False, expectedResult, radius2Total)
